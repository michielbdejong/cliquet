...
DEFAULT_SETTINGS = {
    ...
    'cliquet.cache_url': '',
    'cliquet.cache_pool_class': ('cliquet.storage.postgresql.pooling.'
                                 'QueuePoolWithMaxBacklog'),
    'cliquet.cache_pool_max_backlog': -1,
    'cliquet.cache_pool_max_overflow': 10,
    'cliquet.cache_pool_recycle': 60,
    'cliquet.cache_pool_size': 10,
    ...
    'cliquet.storage_pool_class': ('cliquet.storage.postgresql.pooling.'
                                   'QueuePoolWithMaxBacklog'),
    'cliquet.storage_pool_max_backlog': -1,
    'cliquet.storage_pool_max_overflow': 10,
    'cliquet.storage_pool_recycle': 60,
